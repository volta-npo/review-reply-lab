export const v3 = {
    ...
    "capabilities": [
        "Domain-specific workbench: Review Response Lab",
        "Operational table: Review response queue",
    ...
    "releaseChecklist": [
        ...
        "Response Quality reaches production threshold",
        "Escalation Safety is documented with evidence",
        "Approval Coverage has no unresolved blocker",
        "Positive reply pack verified",
        "Critical review response verified",
        "Tone guide verified"
    ],
    "operations": [
