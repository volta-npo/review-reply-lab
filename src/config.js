    ...
    "criteria": [
        {
            ...
            "guidance": "Implement and verify positive review patterns with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "guidance": "Implement and verify critical review recovery scripts with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "guidance": "Implement and verify escalation guidance with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            "id": "tone-style-cards",
            ...
            "weight": 15,
            "defaultStatus": "not-started",
            "guidance": "Implement and verify tone style cards with evidence that a Volta student pod, mentor, and owner can understand."
        },
        {
            "id": "evidence-quality",
